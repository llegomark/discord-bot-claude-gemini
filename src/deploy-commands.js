...
const commands = [
	new SlashCommandBuilder().setName('clear').setDescription('Clears the conversation history.').setDMPermission(false),
	...
	new SlashCommandBuilder()
		...
		.setDMPermission(false),
	new SlashCommandBuilder().setName('reset').setDescription('Reset the model and prompt to the default settings.').setDMPermission(false),
	new SlashCommandBuilder()
		.setName('help')
